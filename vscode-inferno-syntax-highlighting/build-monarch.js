...
const inFile = path.join(__dirname, 'syntaxes', 'inferno.YAML-tmLanguage');
const outFile = path.join(__dirname, 'syntaxes', 'inferno.monarch.json');
...
monarch.root.push(['[a-z][\\w$]*', 'identifier']);
